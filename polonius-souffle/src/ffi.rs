...
pub use self::ffi::{Tuple1, Tuple2, Tuple3, Tuple4, DynTuples, Program, Relation, load_all, print_all};
...
impl Relation {
    pub fn name(&self) -> String {
        ...
        s.as_ref().expect("Relation must have a name").to_string_lossy().into_owned()
    }
